    ...
    <div class="sidebar-footer">
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-dark shadow">
                <li><a class="dropdown-item" href="profile.php"><i class="fa-solid fa-user me-2"></i>View Profile</a></li>
                <li><a class="dropdown-item" href="profile.php?section=security"><i class="fa-solid fa-gear me-2"></i>Settings</a></li>
